...
const Profile = () => {
  ...
  return (
    ...
    <p className='p'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Diet refers to the food and drink that is regularly consumed by an individual (or a group). During a particular therapy of a disease or management of a particular health condition, the diet may be controlled, i.e. one that meets the physical needs of an individual. For instance, the diet of a diabetic person may be restricted to a selection of food and drinks that help manage the level of blood sugar.</p>
    
    <h3>What is Nutrition?</h3>
    <p className='p'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;“Nutrition is the process of taking in food and converting it into energy and other vital nutrients required for life.” Nutrients are the substances which provide energy and biomolecules necessary for carrying out the various body functions.</p>
